...
with DAG(
    ...
    populate_table = PostgresOperator(
        ...
        postgres_conn_id='postgres_default',
        sql="""
            SELECT aws_s3.table_import_from_s3('user_purchase', 'invoice_number,stock_code,detail,quantity,invoice_date,unit_price,customer_id,country', '(FORMAT CSV, DELIMITER '','', HEADER true, QUOTE ''"'' )', aws_commons.create_s3_uri('second-derivable20211101213449672200000001', 'user_purchase.csv', 'us-east-2') );
          """
    )
