...
with DAG(
    ...
    populate_table = PostgresOperator(
        ...
        postgres_conn_id='postgres_default',
        sql="""
            SELECT aws_s3.table_import_from_s3('user_purchase', '', '(DELIMITER ''|'', HEADER true)', aws_commons.create_s3_uri('second-derivable20211101213449672200000001', 'user_purchase.txt', 'us-east-2') );
          """
    )
