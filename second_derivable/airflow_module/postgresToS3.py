...
with DAG(
    ...
    export_table_to_s3 = PostgresOperator(
        ...
        sql="""
           SELECT *
           FROM aws_s3.query_export_to_s3('SELECT * FROM user_purchase', aws_commons.create_s3_uri('staging20211120201523566000000005', 'postgres/user_purchase.csv','us-east-2'));  
          """
    )
